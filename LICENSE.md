...
1. **Use** — Use, run, and interact with this software for personal, educational, or non-commercial purposes.

2. **Study** — Read, analyze, and learn from the source code.

3. **Modify** — Create derivative works, modifications, or forks for non-commercial purposes.

4. **Share** — Redistribute the original or modified versions, provided:
   - You include this license file
   - You provide clear attribution to the original project
   - You do not charge money or derive commercial benefit

---

### You are NOT permitted to:

1. **Commercial Use** — You may not use this software, in whole or in part, for any commercial purpose. This includes but is not limited to:
...
3. **Sublicense** — You may not grant rights to others that exceed those granted to you by this license.
...
If you wish to use NoteSmith for commercial purposes, please contact the author to discuss licensing options.
...
| Modification | ✅ Allowed (non-commercial) |
| Distribution | ✅ Allowed (with attribution) |
| Commercial use | ❌ Not allowed |
| Selling | ❌ Not allowed |
| SaaS deployment | ❌ Not allowed |
